...
\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\includegraphics{cycle\_menstruel.png}}
...
\end{itemize}
Nous avons pour consigne de reproduire les cycles de concentration de l'estradiol et de la progestérone. Car ce sont 
les hormones suspectées dans l'apparition de l'endométriose.
Nous allons donc devoir recrée les conditions d'homéostasie des cellules ainsi que les conditions de concentration 
de ce cycle et les appliquer à des cellules in vitro.
Afin de répondre au mieux à cette problématique nous allons faire un état de l'art de la culture cellulaire ainsi que des
technologie présente au campus biotech qui pourrait nous aider dans notre projet.
\newpage
...
Il faut compter entre 5 000CHF et 15 000 CHF pour un incubateur professionnel.
...
\begin{itemize}
    ...
    \item Dans les labo d'HEPIA a la FCBG, des biochip en PMMA, un polymere biocompatible.
\end{itemize}
