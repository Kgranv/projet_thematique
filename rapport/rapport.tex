...
\newline
L'ensemble du système est intégré dans un boîtier réalisé en impression 3D et en PMMA. Une version étanche de ce boîtier a été développée pour protéger l'électronique lorsqu'elle est placée dans l'incubateur.
\newline
